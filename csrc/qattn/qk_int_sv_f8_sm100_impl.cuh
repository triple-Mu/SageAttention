...
//
// The kernel body is split out of qk_int_sv_f8_cuda_sm100.cu (which keeps the
...
// unchanged even where the code is (same rule as qk_int_sv_f8_sm90_impl.cuh).
//
// Compile modes:
//   default                     - torch build (extension TUs)
...
// The varlen translation unit compiles a *different* body under the same
// template name and needs its own namespace for the same reason.
#ifndef SAGEATTN_ARCH_NS
#define SAGEATTN_ARCH_NS sm100
#endif
