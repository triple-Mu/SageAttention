...
// (integer IMNMX on steady steps since wave22, C1_DESIGN.md section 14)
...
#pragma unroll
            ...
            //      lock. Same wait, same completion, same phase sequence
            ...
            //      moves: bit-exact. (wave23 fusion: the issue wall below
            //      now pins the exp2 segment under this wait in ALL forms,
            //      subsuming the wave22 SASS-schedule caveat about ptxas
            //      hoisting the FP chain above a data-edge-free spin.) ----
