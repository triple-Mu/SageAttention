...
// CTA_K] in LINEAR kv order (per_channel_fp8 permute=False, the sm100 TS
// contract); the scales are [heads, blocks] and the returned lse (when
// return_lse) is [heads, total_q]. max_seqlen_* size the grid only. See
// attn_cuda_sm100.h for the dense family.
