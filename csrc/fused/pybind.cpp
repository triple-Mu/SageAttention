...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("quant_per_thread_int8_q_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, int, int, int>(&quant_per_thread_int8_q_cuda), "quant_per_thread_int8_q_cuda");
  m.def("quant_per_thread_int8_k_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, int, int, int>(&quant_per_thread_int8_k_cuda), "quant_per_thread_int8_k_cuda");
  m.def("quant_per_thread_int8_k_fuse_sub_mean_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, int, int, int>(&quant_per_thread_int8_k_fuse_sub_mean_cuda), "quant_per_thread_int8_k_fuse_sub_mean_cuda");
  ...
  m.def("transpose_pad_cuda", py::overload_cast<torch::Tensor, torch::Tensor, int>(&transpose_pad_cuda), "transpose_pad_cuda");
