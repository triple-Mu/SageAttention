...
fold 的立项依据本来就是 sm_80/sm_86(A100 复测见
[P8_SM80_FIX_A100.md](P8_SM80_FIX_A100.md):漂移校正后 0.9988,同样
无收益),本轮确认它在 sm_89 上无害(合计 ≤0.05%,逐形状最差 -0.34% 在
b2h3s4096,两轮同向,量级仍在半个百分点以内),不需要动作;回收该 hunk
换简单性的建议在 A100 报告 §5。
